...
import { contractorsApi, permitsApi } from '@/lib/api';
                                    ...
                                    <Card key={contractor.id} className="group border-0 shadow-sm hover:shadow-xl transition-all duration-300 bg-white rounded-3xl overflow-hidden ring-1 ring-slate-100">
                                        <div className="p-6">
                                            ...
                                            <div className="flex gap-3">
                                                <Button variant="outline" className="flex-1 rounded-xl h-11 font-black border-slate-200 text-slate-500 uppercase text-[10px] tracking-widest hover:bg-slate-50 active:scale-95 transition-all">
                                                    {t.common.edit}
                                                </Button>
