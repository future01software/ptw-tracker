...
import { locationsApi, permitsApi, usersApi } from '@/lib/api';
...
export default function LocationsPage() {
    ...
    const handleDelete = async (id: string, name: string) => {
        ...
        try {
            ...
            toast.success(language === 'tr' ? 'Lokasyon silindi' : 'Location deleted');
            fetchData();
        } catch (err: any) {
                                                        ...
                                                        <div className="flex gap-2 justify-end opacity-0 group-hover:opacity-100 transition-opacity">
                                                            {currentUser?.role === 'admin' && (
                                                                <Button
                                                                    ...
                                                                    className="h-9 w-9 p-0 rounded-xl font-bold text-slate-500 hover:text-blue-600 hover:bg-blue-50 transition-all"
                                                                >
                                                            ...
                                                            {currentUser?.role === 'admin' && (
                                                                <Button
                                                                    ...
                                                                    className="h-9 w-9 p-0 rounded-xl font-bold text-slate-500 hover:text-red-600 hover:bg-red-50 transition-all"
                                                                >
